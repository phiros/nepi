...
def add_ping_app(ec, node, remote_ip):
    app = ec.register_resource("linux::ns3::dce::Ping")
    ec.set (app, "stackSize", 1<<20)
    ec.set (app, "count", "20")
    ec.set (app, "packetSize", "1000")
    ec.set (app, "target", remote_ip)
    ec.set (app, "StartTime", "5s")
    ec.set (app, "StopTime", "40s")
